...
public class TakeImageActivity extends AppCompatActivity {
    ...
    private static final int RQ_CAM_PERMISSION = 200;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnOpenCamera=findViewById(R.id.buttonTakePhoto);
        txtResultBody=findViewById(R.id.textViewResults);
        ...
        btnOpenCamera.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ActivityCompat.requestPermissions(TakeImageActivity.this, new
                        String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.CAMERA}, RQ_CAM_PERMISSION);
    ...
    private void takeBarcodePicture() {
        ...
        imageUri = FileProvider.getUriForFile(TakeImageActivity.this,
